...
$(document).ready(function () {
  ...
  `;
    ...
    function renderTicketPages() {
        ...
        console.log("siteContent.setting", siteContent.setting);
        // alert();
        if (siteContent.setting.templateType == "multi_location") {
            const TicketPackage = ({
                id,
                ...
                return `
                <input class="card-input" id="cardInput${id}" type="radio" name="option-card" />
                <label for="cardInput${id}" class="option-card ticket_item" data-id="${id}">
                    <div class="card-body">

                      <h4 class="option-card__header  ">
                        <span class="option-card__amount">${formatCurrency(amount, 0, 0)}</span>
                        ...
                        <span class="currency__amounts py-1 icon">></span>
            ...
            // renderTicketPages();
        } else if (siteContent.setting.templateType == "masbia") {
            const TicketPackage = ({
                id,
                amount,
                entry,
