...
class MasbiaDonationController extends Controller
{
    /**
     * Donation
     */
    public function index(Request $request): View
    {
        ...
        $campaign = Campaign::where('id', 17)->get()[0];

        $mainMenu = CampaignMenu::where('type', 'primary')
        ...
        return view('frontend.templates.masbia-template.donation', compact(
            'campaign',
            'mainMenu',
            'secondaryMenu',
            'packages',
