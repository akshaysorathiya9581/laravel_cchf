{{-- GALLERY ADD MODAL --}}
<div class="modal fade" id="add_gallery" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.storeGallery') }}" id="addGalleryForm" enctype="multipart/form-data"
                    method="POST">
                    <div class="card-body pt-">
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <textarea class="form-control form-control-lg form-control-solid" name="embed" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="button" id="addGallery" class="btn btn-lg btn-primary"
...
<script>
    $(document).ready(function() {
        $('#addGallery').click(function() {
            ...
            let action = $('#addGalleryForm').attr('action');
