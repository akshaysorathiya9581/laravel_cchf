...
{{-- PLEDGER MODAL --}}
<div class="modal fade" id="pledger_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            <div class="modal-header py-7 d-flex justify-content-between">
                <h2>Pledger Configurations</h2>
                ...
                <form action="{{ route('admin.updatePaymentMethodForm') }}" method="post"  class="updatePaymentMethodForm">
                    <div class="card-body pt-">
                        <div class="w-100">
                            ...
                            <input type="hidden" value="pledger" name="payment_method">
                            ...
                            <div class="fv-row mb-10">
                                <label class="d-flex align-items-center form-label">
                                    <span class="">Authorization Header Bearer Token</span>
                                </label>
                                <input name="test_public_key" class="testPublicKey form-control form-control-lg form-control-solid" />
                            </div>
                            {{-- <div class="fv-row mb-10">
                                <label class="d-flex align-items-center form-label">
                                    <span class="">Transaction Key</span>

                                </label>
                                <input name="test_api_key" type="hidden" class="testApiKey form-control form-control-lg form-control-solid" />
                            </div> --}}
                        ...
                        <div class="w-100">
                            ...
                            {{-- <div class="fv-row mb-10">
                                ...
                                <input name="live_api_key" type="hidden" class="liveApiKey form-control form-control-lg form-control-solid" />
                            </div> --}}
                        </div>
                    </div>

                    <div class="d-flex justify-content-end">
                        <button  type="button" data-modal="#pledger_modal" class="btn updatePaymentModal btn-lg btn-primary" data-kt-element="type-next">
