            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <div class="m-0">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#add_coupon_modal"
                                class="btn btn-sm btn-flex btn-info"> <i class="fas fa-user"></i> Add New</button>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" type="button"
                                                            data-route="{{ route('admin.getCouponSingledata') }}"
                                                            data-id="{{ $coupon->id }}"
                                                            id="update_coupon{{ $coupon->id }}"
                                                            class="loadUpdateCouponModal menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.coupon.destroy', ['couponId' => $coupon->id]) }}"
            ...
            ajaxCall(
                ...
                function(response) {
                    ...
                    for (let i = 0; i < campaignsCount; i++) {
                        ...
                        option += '<option ' + selected + ' value="' + campaigns[i].id + '" >' + campaigns[i]
                            .camp_title + '</option>';
                    }
                    $('#Seasons').html('');
                    ...
                    for (let i = 0; i < seasonsCount; i++) {
                        ...
                        season_option += '<option ' + selectedseason + ' value="' + seasons[i].id + '" >' +
                            seasons[i].name + '</option>';
                    }
