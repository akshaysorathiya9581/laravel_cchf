    ...
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.updateGifts') }}" id="UpdateGiftForm" enctype="multipart/form-data"
                    method="POST">
                    ...
                    <div class="card-body pt-">
                        <div class="w-100">
                            <div class="fv-row mb-10">
                                ...
                                <input name="name" id="editGiftName" required
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input name="amount" id="editGiftAmount" type="number" required
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input name="draw_date" id="editGiftDrawDate" type="datetime-local"
                                    class="form-control form-control-lg form-control-solid" />
                            </div>
                            <div class="fv-row mb-10">
                                <label class="form-label">Details</label>
                                <textarea name="details" id="EditGiftDetails" class="area_editor form-control form-control-lg form-control-solid"
                                    cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="button" id="updateGift" class="btn btn-lg btn-primary"
