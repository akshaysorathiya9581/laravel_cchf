{{-- ADD NEW PRIZE MODAL --}}
<div class="modal fade" id="add_Prize_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg p-9">
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-3">
                <form action="{{ route('admin.storePrizes') }}" id="addPrizeForm" enctype="multipart/form-data"
                    method="POST">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="image-input image-input-empty image-input-outline image-input-placeholder"
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px"
                                        @if (isset($prize->image)) style="background-image: url('{{ $prize->image }}');" @endif>
                                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="addPrize" class="btn btn-lg btn-primary"
...
<script>
    $(document).ready(function() {
        $('#addPrize').click(function() {
            let formData = new FormData($('#addPrizeForm')[0]);
            formData.append('_token', '{{ csrf_token() }}'); // Add CSRF token if required
            let action = $('#addPrizeForm').attr('action');
            ajaxCall(
