	...
	<section class="hero">
		<div class="hero__wrapper donate">
			<div class="container">
				...
				<img class="section-ic" src="{{ asset('assets/frontend/templates/masbia/images/icons/donate-section-ic.svg') }}" alt="">
				<h2 class="section-title"><strong>Sponsor Food</strong> to Masbia</h2>
				<p class="text mb-0">Throughout the Passover season, Masbia expects to distribute raw food packages, which will
					include special holiday staples for families to be able to prepare their own Seder and Kosher for Passover
				</p>
				<div class="hero-btns">
					<a href="javascript:void(0)" class="btn goto-donate btn--white">
						<span>Donate</span>
				...
				<img class="hero-img" src="{{ asset('assets/frontend/templates/masbia/images/hands-white.svg') }}" alt="">
				</div>
			</div>
		</div>
	</section>

	<section class="sponsor-s" id="sc-donate">
	  <div class="sponsor">
		...
		<div class="sponsor__payment-method">
		  <div>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment/visa.svg') }}" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/amex.svg" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/discover.svg" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/mastercard.svg" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/PayPal.svg" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/ojcfund.svg" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/paypal2.svg" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/pledger.svg" alt="">
			</a>
			<a href="#">
			  <img src="{{ asset('assets/frontend/templates/masbia/images/payment') }}/donorsfund.svg" alt="">
			</a>
		  </div>
		  ...
		  <div class="sponsor__options-tabs">
			<ul class="tab-list" data-active-tab="tab1">
			  @foreach (get_sustainer_options_list() as $key => $value)
				<li><a href="#tab{{$value['id']}}" class="tab-link btn-filter" data-tab="tab{{ $value['id'] }}" data-id="{{ $value['id'] }}" data-name="sustainer_option_id">{{ ($value['text'] == 'oneTime') ? 'One Time' : $value['text'] }}</a></li>
			  @endforeach
			</ul>
			<div class="tac">
			  <button class="sponsor__tooltip mt-0 tooltip" style="opacity: 1">
				...
				<p class="mb-0 mt-0">It it works?</p>
...
@include('frontend.templates.masbia-template.checkout-popup')
